...
export const DICTS: Record<Locale, Dict> = { es, ca, en };

/** Every page that exists in all three languages. Keyed for path building. */
export type PageKey = "home" | "services" | "aircon" | "areas" | "contact" | "legal" | "privacy";
 ...
 *
 * Castellano is unprefixed, so anything that is not /ca/… or /en/… is Spanish.
 ...
 * /servicios/, /serveis/ and /services/ are the same page — which is what
 * makes the language switcher land on the equivalent page rather than the
 * home page, and what makes the hreflang set correct.
 */
...
/** hreflang set for one page: all three languages plus x-default on Castellano. */
